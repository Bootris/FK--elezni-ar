...
class StaffMemberResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Stručni štab i treneri';

    protected static ?string $modelLabel = 'član štaba';

    protected static ?string $pluralModelLabel = 'stručni štab i treneri';
